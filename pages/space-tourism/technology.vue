<template>
  <div
    class="bg-[url('/space-tourism/bg-technology-desktop.jpg')] h-screen bg-no-repeat bg-cover bg-center px-8 py-32 text-slate-200"
  >
    <div class="h-full pb-20 flex justify-between items-end max-w-7xl mx-auto">
      ...
      <div class="px-10 flex-1 flex justify-center items-center">
        <img src="/space-tourism/crew/image-anousheh-ansari.png" alt="" />
      </div>
    </div>
  </div>
</template>
